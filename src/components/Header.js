  ...
  return (
    <>
        <GithubCorner
            ...
            direction="right" 
        />
        <Tilt scale={0.7} className="z-40">
            <div data-aos="fade-down" data-aos-delay="500" className="m-[30px] h-[100px] bg-[#141a17] flex items-center justify-between shadow-top shadow-down rounded-[100px] py-[15px] px-[20px] relative">
